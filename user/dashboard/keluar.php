...
if(isset($_POST["submit"])){
  simpan_absen_keluar();
	...
	// if (simpan_absen_keluar($_POST) > 0) {
	// 	echo "
	// 			<script>
	...
	// } else{echo "
	// 			<script>
	// 				alert('Anda Belum Absen Masuk! Silahkan Absen Masuk Terlebih Dahulu');
	// 				document.location.href= 'keluar.php';
	// 				</script>
	// 		";	
	// }
        	...
        	<form action="" method="post">
				<ul>
					...
					<li>
						...
						<input type="text" name="keluar" id="keluar" value="<?php echo $jamSekarang ?>"readonly>
