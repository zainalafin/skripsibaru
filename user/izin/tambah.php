					...
					<form action="" method="post">
						<ul>
							...
							<li>
								...
								<input type="text" name="nama_krywn" id="nama_krywn" required>
							</li>
							<li>
							...
							<li>
								...
								<input type="text" name="tgl_lhr" id="tgl_lhr"required>
							</li>
							<li>
							...
							<li>
								...
								<input type="text" name="kd_jabatan" id="kd_jabatan"required>
							</li>
							<li>
