        ...
        <form action="" method="post">
            <ul>
              <li>
                ...
                <input type="text" name="username" id="username" value="<?php echo $ambil['username'] ?>" readonly>
              </li>
              <li>
              <label for="nama_krywn">Nama Karyawan :</label>
                <input type="text" name="nama_krywn" id="nama_krywn" value="<?php echo $ambil['nama_krywn']; ?>" readonly>
              </li>
              <li>
