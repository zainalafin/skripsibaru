...
$result = mysqli_query($conn, "SELECT * FROM user LIMIT $awaldata, $dataperhalaman");

// tombol cari di tekan
if (isset($_POST["cari"])) {
	$result = cari_karyawan($_POST["keyword"], $awaldata, $dataperhalaman);
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <!--sidebar end-->
  <div class="content">
  	<div class="card"><h1>Data Karyawan</h1></div>
  <div class="card">
    <a href="tambah.php" style="background-color: white"> Tambah Karyawan</a>
  </div>
  <div class="card">
  ...
  <table border="1" cellpadding="10" cellspacing="0">
    ...
    <tr>
      ...
      <td>
        ...
        <a href="reset.php?id=<?= $row["id"];?>">Reset PW</a>
      </td>
    ...
    <?php if ( $halamanaktif>1): ?>
      <a href="?halaman=<?=$halamanaktif-1; ?>" style="background-color: white">&laquo;</a>
    <?php endif; ?>
