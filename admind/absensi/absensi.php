...
$result = mysqli_query($conn, "SELECT * FROM absensi LIMIT $awaldata, $dataperhalaman");
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="mobile_nav">
      ...
      <a href="absensi.php"><i class="fas fa-box"></i> <span> Data Absensi</span></a>
      <a href="cuti.php"><i class="fas fa-th"></i><span>Data Cuti</span></a>
      <a href="izin.php"><i class="fas fa-receipt"></i><span>Data Izin</span></a>
